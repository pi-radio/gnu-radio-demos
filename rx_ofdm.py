...
class rx_ofdm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.payload_equalizer = payload_equalizer = digital.ofdm_equalizer_simpledfe(fft_len, payload_mod.base(), occupied_carriers, pilot_carriers, pilot_symbols, 1, 0.1, 1, 1)
        self.packet_len = packet_len = 96
        self.if_freq = if_freq = 1e9
        ...
        self._tx_gain_range = qtgui.Range(0, 90, 1, 50, 200)
        ...
        self._rx_gain_range = qtgui.Range(0, 72, 1, 0, 200)
        ...
        self.uhd_usrp_sink_0.set_center_freq(if_freq, 0)
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(0.02)
    ...
    def set_pilot_symbols(self, pilot_symbols):
        ...
        self.set_payload_equalizer(digital.ofdm_equalizer_simpledfe(self.fft_len, payload_mod.base(), self.occupied_carriers, self.pilot_carriers, self.pilot_symbols, 1, 0.1, 1, 1))
    ...
    def set_if_freq(self, if_freq):
        ...
        self.uhd_usrp_sink_0.set_center_freq(self.if_freq, 0)
